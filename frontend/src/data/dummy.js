...
export const gridOrderdescription = (props) => (
  <button
    type="button"
    style={{ background: props.descriptionBg }}
...
const customerGriddescription = (props) => (
  <div className="flex gap-2 justify-center items-center text-gray-700 capitalize">
    <p style={{ background: props.descriptionBg }} className="rounded-full h-3 w-3" />
...
export const customersGrid = [
  ...
  },
  {
    ...
    format: 'yMd',
    textAlign: 'Center',
    template: customerGriddescription
  },
  {
    field: 'Weeks',
    headerText: 'Weeks',
